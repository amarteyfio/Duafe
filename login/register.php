    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="block text-center">
          ...
          <form class="text-left clearfix" id="registration_form">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-main text-center" name="submit" id="submit">Sign Up</button>
            </div>
          </form>
