            ...
            <?php foreach($artists as $artist): ?>
      		<div class="col-md-6">
		        <div class="post">
		          ...
		          <h2 class="post-title"><?php echo $artist['artist_name']; ?></a></h2>
		          <div class="post-meta">
		          </div>
		          <div class="post-content">
		            <p>Email: <?php echo $artist['artist_email'] ;?></p>
                    <p>Contact: <?php echo $artist['artist_contact']; ?></p>
                    <p>Page:  <?php echo $artist['artist_page']; ?></p>
		            <a href="https://<?php echo $artist['artist_page']; ?>" class="btn btn-main">Go to Page</a>
		          </div>
				</div>
        	</div>
            <?php endforeach; ?>
