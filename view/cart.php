                    ...
                    <tr class="">
                      <td class="">
                        <div class="product-info">
                          <img width="80" src="<?php echo $prods['product_image'];?>" alt="" />
                          <a href=""><?php echo $prods['product_name'];?></a>
                        </div>
                      </td>
                      <td class=""><?php echo $item['amount'];?></td>
                      <td class="">
                        <a class="product-remove" href="../actions/remove_from_cart.php?p_id=<?php echo $item['p_id'];?>">Remove</a>
                      </td>
                    </tr>
					<?php endforeach; ?>
                  </tbody>
