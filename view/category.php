...
{
	$category_id = get_category_id_ctrl(urldecode($_GET['category']));
	...
	$products = select_product_by_cat_ctrl($category_id);
			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						...
						<img class="img-responsive" src="<?php  echo $row['product_image'];?>" alt="product-img" style="width: 400px; height:400px;"/>
						<div class="preview-meta">
							<ul>
							<li>
			                    <a href="product-single.php?product=<?php echo $row['product_name']; ?>" ><i class="tf-ion-ios-search-strong"></i></a>
							</li>
							</ul>
                      	</div>
					</div>
