			...
			<div class="col-md-4">
				<div class="product-item">
					<div class="product-thumb">
						<img class="img-responsive" src="<?php echo $product['product_image']; ?>" alt="product-img" style="width: 400px; height:400px;"/>
						<div class="preview-meta">
							<ul>
							<li>
			                    <a href="product-single.php?product=<?php echo $product['product_name']; ?>" ><i class="tf-ion-ios-search-strong"></i></a>
							</li>
							</ul>
                      	</div>
					</div>
