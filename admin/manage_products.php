                                        ...
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="edit_product.php?id=<?php echo $row['product_id']; ?>"><button class="btn btn-primary btn-rounded m-b-10 m-l-5">Edit</button></a></td>
                                                    <td><a onclick = "return confirm('Are you sure you want to delete? Action is irreversible')" href="../actions/delete_product.php?id=<?php echo $row['product_id']; ?>"><button class="btn btn-danger btn-rounded m-b-10 m-l-5">Delete</button></a></td>
                                                    <td><a href="set_bid.php?id=<?php echo $row['product_id']; ?>"><button class="btn btn-primary btn-rounded m-b-10 m-l-5">Set</button></a></td>
                                                </tr>
                                                <?php endforeach;?>
                                            </tbody>
                                        </table>
