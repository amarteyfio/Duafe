                                    ...
                                    <div class="basic-form">
                                        <form id="add_cat">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="e.g Digital Art" id="cat">
                                            </div>
                                        ...
                                        <table class="table table-hover ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="manage_category.php?id=<?php echo $row['category_id']; ?>"><button class="btn btn-primary btn-rounded m-b-10 m-l-5">Edit</button></a></td>
                                                    <td><a onclick = "return confirm('Are you sure you want to delete?(Action is Irreversible)')" href="../actions/delete_category.php?id=<?php echo $row['category_id']; ?>"><button class="btn btn-danger btn-rounded m-b-10 m-l-5">Delete</button></a></td>
                                                </tr>
                                                <?php endforeach;?>
                                            </tbody>
                                        </table>
